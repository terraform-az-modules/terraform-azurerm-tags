...
**IMPORTANT:** Since the master branch used in source varies based on new modifications, we recommend using the [release versions](https://github.com/terraform-az-modules/terraform-azure-tags/releases).
...
| environment   | Deployment environment (e.g., `dev`, `test`, `prod`).              | `string`     | n/a                                                |  yes     |
...
| managedby     | Identifier for the managing entity or tool.                        | `string`     | `"terraform-az-modules"`                           |   no     |
| business_unit | Name of the business unit this resource belongs to.                | `string`     | `"Corp"`                                           |   no     |
| attributes    | Additional attributes (e.g., `public`, `private`).                 | `list(any)`  | <pre>["private"]</pre>                             |   no     |
| extra_tags    | Additional custom tags to be merged with default tags.             | `map(any)`   | `{ Application = "test-app" }`                     |   no     |
...
| deployment_mode | Normalized deployment mode.        |
...
<a href="https://github.com/terraform-az-modules/terraform-azure-tags/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=terraform-az-modules/terraform-azure-tags&max" />
</a>
<br>
<br>
...
## Feedback 
Spot a bug or have thoughts to share with us? Let's squash it together! Log it in our [issue tracker](https://github.com/terraform-az-modules/terraform-azure-tags/issues), feel free to drop us an email at [hello@clouddrove.com](hello@clouddrove.com)).

Show some love with a ★ on [our GitHub](https://github.com/terraform-az-modules/terraform-azure-tags)!  if our work has brightened your day! – your feedback fuels our journey!
